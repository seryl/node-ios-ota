...
(function() {
  var Config, Logger, RedisUtility, RedisUtils, Singleton, async, bcrypt, redis,
    ...
    RedisUtility.prototype.modify_redis = function() {
      ...
      */
      ...
      this.redis.add_or_update_user = function(user, fn) {
        var success, user_prefix;
        user_prefix = ''.concat(_this.redis.prefix('user'), '-', user.username);
        success = _this.redis.hmset(user_prefix, user);
        _this.redis.sadd(_this.redis.prefix('users'), user.username);
      ...
      */
      ...
      return this.redis.remove_user = function(username, fn) {
        ...
        return _this.redis.hdel(user_prefix, function(err, res) {
