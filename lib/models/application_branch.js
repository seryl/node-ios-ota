...
(function() {
  var ApplicationBranch, BranchArchive, Files, RedisObject, async, fs,
  ...
  */
  ...
  ApplicationBranch = (function(_super) {
    ...
    function ApplicationBranch(user, application, branch) {
      ...
      this.archives = __bind(this.archives, this);
    ...
    */
    ...
    ApplicationBranch.prototype.save = function(fn) {
      ...
      status = stat_add ? null : {
        message: "Error saving branch: `" + this.user + "/" + this.application + "/branches/" + this.current + "`."
      };
    ...
    */
    ...
    ApplicationBranch.prototype["delete"] = function(branch, fn) {
      ...
      this.archives().delete_all(function(err, reply) {});
    ...
    */
    ...
    ApplicationBranch.prototype.delete_all = function(fn) {
      ...
      return this.list(function(err, branchlist) {
        return async.each(branchlist, _this["delete"], fn);
      });
    };
      ...
      return fs.exists(target, function(exists) {
        if (!exists) {
          return fs.mkdir(target, function(err, made) {
            ...
            return fs.mkdir([target, "archives"].join('/'), function(err, made) {
              if (err) {
                _this.logger.error("Error setting up directories for `" + dirloc + "/archives`");
              }
              return fn(err, made);
            });
          });
    ...
    */
    ...
    ApplicationBranch.prototype.archives = function() {
      return new BranchArchive(this.user, this.application, this.current);
    };
    ...
    */
    ...
    ApplicationBranch.prototype.delete_directories = function(branch, fn) {
      ...
      return fs.rmdir(fulldir, function(err) {
        ...
        return fs.rmdir([fulldir, "archives"].join('/'), function(err) {
          if (err) {
            _this.logger.error("" + msg + " `" + dirloc + "/archives`.");
            return fn(null, true);
          }
        });
      });
