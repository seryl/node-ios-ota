...
(function() {
  var RedisObject, RedisSingleton,
  ...
  */
  ...
  RedisObject = (function() {
    ...
    */
    ...
    RedisObject.prototype.find_one = function(query, fn) {
      this.current = null;
      return this.find(query, function(err, obj) {
        return fn(err, obj);
      });
    };
    ...
    */
    ...
    RedisObject.prototype.update = function(obj, fn) {
      if (!this.current) {
        return fn(null, false);
      }
      return fn(null, true);
