...
(function() {
  var Application, RedisObject, User, async, fs, generate_identity, logger, merge, mkdirp,
  ...
  User = (function(_super) {
    ...
    */
    ...
    User.prototype.setup_directories = function(username, fn) {
      var _this = this;
      return mkdirp([config.get('repository'), username].join('/'), function(err, made) {
        if (err) {
    ...
    */
    ...
    User.prototype.delete_directories = function(username, fn) {
      var _this = this;
      return fs.rmdir([config.get('repository'), username].join('/'), function(err) {
        if (err) {
