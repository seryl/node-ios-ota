...
(function() {
  var RedisObject, User, UserApp, fs, generate_identity, merge,
  ...
  User = (function(_super) {
    ...
    */
    ...
    User.prototype["delete"] = function(username, fn) {
      ...
      this.redis.del(this.user_prefix());
      return fn(null, true);
    };
    ...
    */
    ...
    User.prototype.exists = function(username, fn) {
      var _this = this;
      return this.redis.sismember(this.userlist_prefix(), username, function(err, reply) {
        return fn(err, reply);
      });
    };
    ...
    */
    ...
    User.prototype.setup_directories = function(user, fn) {
      var _this = this;
      return fs.mkdir([this.config.get('repository'), user.username].join('/'), function() {});
    };
    ...
    */
    ...
    User.prototype.applications = function() {
      return new UserApp(this.current.name);
    };
