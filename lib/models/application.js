...
(function() {
  var Application, ApplicationBranch, ApplicationTag, RedisObject, async,
  ...
  */
  ...
  Application = (function(_super) {
    ...
    function Application(user, application) {
      this.user = user;
      if (application == null) {
        application = null;
      }
      ...
      this.save_app = __bind(this.save_app, this);
      ...
      Application.__super__.constructor.call(this, application);
    ...
    */
    ...
    Application.prototype.save_app = function(obj, fn) {
    ...
    */
    ...
    Application.prototype.branches = function() {
      return new ApplicationBranch(this.current.name);
    };
    ...
    */
    ...
    Application.prototype.tags = function() {
      return new ApplicationTag(this.current.name);
    };
