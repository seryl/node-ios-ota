...
(function() {
  ...
  */
  ...
  BranchArchive = (function(_super) {
    ...
    function BranchArchive(user, application, branch) {
      this.user = user;
      ...
      BranchArchive.__super__.constructor.call(this, branch);
      this.basename = "node-ios-ota::applications";
      this.object_name = 'branch_archives';
    }
    ...
    */
    ...
    BranchArchive.prototype["delete"] = function(branch, fn) {
      var _this = this;
      this.current = branch;
    ...
    */
    ...
    BranchArchive.prototype.setup_directories = function(branch, fn) {
      var dirloc, target,
        _this = this;
    ...
    */
    ...
    BranchArchive.prototype.delete_directories = function(branch, fn) {
      var dirloc,
        _this = this;
      dirloc = [this.user, this.application, this.object_name, branch].join('/');
