  ...
  */
  ...
  WebServer = (function() {
    ...
    WebServer.prototype.setup_routing = function() {
      ...
      this.app.get('/upload', function(req, res, next) {
        res.writeHead(200, {
          'content-type': 'text/html'
        });
        return res.end("<form action=\"/upload\" enctype=\"multipart/form-data\" method=\"post\">\n<input type=\"text\" name=\"title\"><br>\n<input type=\"file\" name=\"upload\" multiple=\"multiple\"><br>\n<input type=\"submit\" value=\"Upload\">\n</form>");
      });
      ...
      this.app.post('/:user/:app/branches/:branch', function(req, res, next) {
        ...
        return branch.save(function(err, reply) {
          ...
          if (typeof req.files.files === void 0) {
            return res.json(200, {
              name: reply
            });
          } else {
            ...
            flist = [
              (function() {
                ...
                _ref1 = Object.keys(req.files.files);
                _results = [];
                for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
                  k = _ref1[_i];
                  _results.push(req.files.files[k]);
                }
                return _results;
              })()
            ];
