  ...
  WebServer = (function() {
    ...
    WebServer.prototype.setup_routing = function() {
      ...
      this.app.del('/:user', function(req, res, next) {
        var _ref1;
        if ((_ref1 = req.params.user) === "help" || _ref1 === "users") {
          return res.json(403, {
            code: 403,
            message: "Unable to modify internal services."
          });
        }
        return _this.redis.remove_user(req.params.user, function(err, reply) {
          if (err) {
            return res.json(500, {
              code: 500,
          ...
          return res.json(200, {
            message: ''.concat("Successfully deleted the user `", req.params.user, "`.")
          });
        });
      });
